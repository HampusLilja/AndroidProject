...
public class GCM_Server extends HttpServlet implements Serializable {
    ...
    */
    private static String DBURL = "jdbc:sqlite:C:\\Tomas\\Software Engineering\\ShutAPP_GCM_SERVER\\src\\main\\webapp\\shutappdb_v3.db";
...
.build();
    ...
    private void applyChangesToSQL(String var1, String var2, String var3, String var4, String var5, String var6, String sqlstatement){
      ...
      try{
        ...
        sendMsgToChatRoom(buildMsg(chatRoom, "User active in " +chatRoom , "SERVER"), convertToArrayListForGCM(chatRoom));
